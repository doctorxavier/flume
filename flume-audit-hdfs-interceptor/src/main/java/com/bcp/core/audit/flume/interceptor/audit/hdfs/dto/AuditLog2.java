...
public class AuditLog2 implements Serializable {
	...
	public String getDataToken2() {
		return dataToken2;
	}

	public void setDataToken2(String dataToken) {
		this.dataToken2 = dataToken;
	}
}
